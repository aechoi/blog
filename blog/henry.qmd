...
::: {layout-ncol=2}
![A closeup of Henry's face](henry/figs/closeup.png)

![A closer up](henry/figs/closerup.png)
:::

After experimenting a bit, I made the following CAD models in SolidWorks to begin printing of the parts (Ender 3). 

::: {layout-ncol=3}
![](henry/figs/henry_front.png){height=3}

![](henry/figs/henry_back.png){height=3}

![](henry/figs/henry_explode.png){height=3}
...
::: {layout-ncol=2}
![](henry/figs/wiring.webp){height=4}

![](henry/figs/wiring_setup.webp){height=4}
:::
...
::: {layout-ncol=2}
![](henry/figs/board_face.png)

![](henry/figs/board_shield.png)
:::
...
::: {layout-ncol=2}
![](henry/figs/installed_board_face.webp){height=4}

![](henry/figs/installed_board_shield.webp){height=4}
:::
...
::: {layout-ncol=2}
![](henry/figs/smile_full.png){height=2} 

![](henry/figs/smile_smirk.png){height=2} 
:::
